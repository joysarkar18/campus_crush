...
import 'package:campus_crush/modules/$moduleName/bloc/${moduleName}_event.dart';
import 'package:campus_crush/modules/$moduleName/bloc/${moduleName}_state.dart';
...
void addRouteToAppPages(String routeName, String className) {
  ...
  final importEntry =
      "import 'package:campus_crush/modules/$routeName/screen/${routeName}_view.dart';\n";
  final routeEntry = '''
    GoRoute(
